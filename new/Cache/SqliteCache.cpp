...
SqliteCache::SqliteCache(fs::path database_path)
...
bool SqliteCache::exec(const char* sql) const
{
...
std::vector<CacheEntry> SqliteCache::loadAll()
{
...
bool SqliteCache::upsertBatch(const std::vector<CacheEntry>& entries)
{
...
bool SqliteCache::removeBatch(const std::vector<std::string>& paths)
{
